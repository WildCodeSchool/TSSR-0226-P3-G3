...
**En cas de volonté d'installer un rôle AD DS il est recommandé d'installer le rôle DNS en même temps. Pour celà se référer au fichier [Installation.md](https://github.com/WildCodeSchool/TSSR-0226-P3-G3/blob/main/components/AD%20DS/Installation.md) du dossier AD DS**
